    ...
    return (
        <Stack className={"filter-main"}>
            ...
            <Stack className={"find-your-home"} mb={"30px"}>
                ...
                >
                    {["SEOUL", "BUSAN", "DEAGU"].map((location: string) => {
                        return (
            ...
            <Stack className={"find-your-home"} mb={"30px"}>
                ...
                <Stack className={"input-box"}>
                    <Checkbox
                        ...
                        color="default"
                        size="small"
                        value={"proeprtyBarter"}
                    />
                    <label htmlFor={"Barter"} style={{ cursor: "pointer" }}>
                        <Typography className={"proeprty-type"}>Barter</Typography>
                    </label>
                </Stack>
                <Stack className={"input-box"}>
                    <Checkbox
                    ...
                    />
                    <label htmlFor={"Barter"} style={{ cursor: "pointer" }}>
                        <Typography className={"proeprty-type"}>Rent</Typography>
                    </label>
                </Stack>
            </Stack>
